// Jevline verify + admin + download in one module (Vercel serverless)
// Routes:
...
const PEPPER = process.env.ACCESS_PEPPER || 'jevline-pepper-sse9wpkl';

const FILES = [
  '01-typed-decision-playbook.pdf',
  '02-question-shaper-primitive-selector.pdf',
  '03-threshold-calibration-kit.pdf',
  '04-abstention-escalation-design.pdf',
  '05-cascade-cost-blueprint.pdf',
  '06-decision-ledger-drift-watch.pdf',
  '07-failure-mode-playbook.pdf',
  '08-30-day-rollout-playbook.pdf',
];
